...
teleportPadding.PaddingTop = UDim.new(0, 5)
teleportPadding.PaddingBottom = UDim.new(0, 15)
teleportPadding.PaddingLeft = UDim.new(0, 5)
teleportPadding.PaddingRight = UDim.new(0, 5)
...
local function createTeleportZone(zone, order)
	...
	gridLayout.CellSize = UDim2.new(0.32, 0, 0, 55)
	...
	for index, location in ipairs(zone.Locations) do
