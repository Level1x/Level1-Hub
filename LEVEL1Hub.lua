...
local THEME = {
	...
	Rare = Color3.fromRGB(70, 190, 255),
	SuperRare = Color3.fromRGB(65, 225, 120),
...
sidebar.Position = UDim2.new(0, 20, 0, 73)
...
content.Size = UDim2.new(0, 400, 1, -88)
content.Position = UDim2.new(0, 200, 0, 73)
...
previewPanel.Size = UDim2.new(0, 275, 1, -88)
previewPanel.Position = UDim2.new(1, -295, 0, 73)
...
for index, category in ipairs(categories) do
	...
	categoryButton.Text = RARITY_DISPLAY[category] or "ALL FISH"
